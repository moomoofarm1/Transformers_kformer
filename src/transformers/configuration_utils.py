...
class PretrainedConfig(PushToHubMixin):
    ...
    Arg:
        ...
        knowledge (`List[int]`, *optional*, defaults to [-1, -1]):
            Specifies the transformer layers where knowledge neural network will be added. List must have two indexes.
            The first is the init layer and the second the final layer.
    ...
    def __init__(self, **kwargs):
        ...
        self.knowledge = kwargs.pop("knowledge", [-1, -1])
