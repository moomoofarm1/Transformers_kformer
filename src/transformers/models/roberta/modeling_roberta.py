...
class RobertaLayer(nn.Module):
    def __init__(self, config, add_known=False):
        # CG. New parameter add_known
        super().__init__()
...
class RobertaEncoder(nn.Module):
    def __init__(self, config):
        ...
        # CG. Add knowledge only in the layers specified in config.knowledge
        self.layer = nn.ModuleList([
            RobertaLayer(config, add_known=config.knowledge[0] <= i <= config.knowledge[1])
